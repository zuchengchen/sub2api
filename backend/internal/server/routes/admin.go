...
func registerContentModerationRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	risk := admin.Group("/risk-control")
	{
		...
		risk.GET("/usage-policy", h.Admin.UsagePolicy.GetConfig)
		risk.PUT("/usage-policy", h.Admin.UsagePolicy.UpdateConfig)
		risk.GET("/usage-policy/stats", h.Admin.UsagePolicy.GetStats)
...
func registerIntelligentTestRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	tests := admin.Group("/intelligent-tests")
	{
		...
		tests.GET("/records/:id/html", h.Admin.IntelligentTest.HTML)
...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/workers/status", h.Admin.Ops.GetWorkerRuntimeStatus)
		ops.GET("/billing-outbox/health", h.Admin.Ops.GetBillingOutboxHealth)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/vip", h.Admin.User.SetVIP)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/guide", h.Admin.Setting.GetGuide)
		adminSettings.PUT("/guide", h.Admin.Setting.UpdateGuide)
		adminSettings.POST("/guide/restore", h.Admin.Setting.RestoreGuide)
		adminSettings.POST("/guide/reset", h.Admin.Setting.ResetGuide)
		adminSettings.GET("/guide/assets", h.Admin.Setting.ListGuideAssets)
		adminSettings.POST("/guide/assets", h.Admin.Setting.UploadGuideAsset)
		adminSettings.DELETE("/guide/assets/:id", h.Admin.Setting.DeleteGuideAsset)
