...
type AdminService interface {
	...
	SetUserVIP(ctx context.Context, userID int64, vip bool) (*User, error)
	...
	AdminUpdateAPIKeyConcurrency(ctx context.Context, keyID int64, concurrency int) (*APIKey, error)
