...
func (h *AccountHandler) enrichCodexTicketStatus(account *service.Account, out *dto.Account) {
	if h != nil && h.cfg != nil && out != nil {
		...
		out.CodexTurnTickets = h.accountTestService.OpenAICodexTicketStatuses(account, cfg, time.Now())
	}
}
...
func (h *AccountHandler) GetAvailableModels(c *gin.Context) {
	...
	if account.IsOpenAI() {
		...
		response.Success(c, service.MergeOpenAIAccountTestModels(nil, account))
		return
	}
