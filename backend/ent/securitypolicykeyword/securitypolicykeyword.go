...
const (
	// Label holds the string label denoting the securitypolicykeyword type in the database.
	Label = "security_policy_keyword"
	...
	EdgeGroup = "group"
	// Table holds the table name of the securitypolicykeyword in the database.
	Table = "security_policy_keywords"
	// GroupTable is the table that holds the group relation/edge.
	GroupTable = "security_policy_keywords"
...
// Columns holds all SQL columns for securitypolicykeyword fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the SecurityPolicyKeyword queries.
