...
// ── Platform config ──
const platformOrder: GroupPlatform[] = ['anthropic', 'openai', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'opencode_go']
// Composite pricing/mapping may target every concrete schedulable provider.
const compositePlatforms: GroupPlatform[] = ['anthropic', 'openai', 'grok', 'kimi', 'zhipu', 'deepseek', 'minimax', 'opencode_go']
