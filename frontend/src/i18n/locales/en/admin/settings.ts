export default {
    settings: {
      ...
      guideEditor: {
        title: 'Usage Guide Editor',
        description: 'Every chapter is edited on its own: pick one on the left, edit it on the right. After publishing, every domain serves the new content on /guide with no rebuild or restart. Markdown is supported and unsafe preview content is removed automatically.',
        openGuide: 'Open guide',
        currentVersion: 'Current version: {version}',
        databaseContent: 'Database content',
        bundledContent: 'Bundled guide',
        updatedAt: 'Updated: {date}',
        markdown: 'Guide content (Markdown)',
        chapters: 'Chapters',
        chapterCount: '{count} chapters',
        editingChapter: 'Editing: {title}',
        anchorHint: 'This chapter is anchored at #{slug}. Renaming the title keeps it, so shared links stay valid.',
        ...
        deleteChapterMessage: 'Delete the chapter anchored at #{slug}? Once published it disappears from the guide and links to it stop working.',
        importBundled: 'Import {count} chapter(s) missing from the bundled guide',
        chapterTooLarge: 'This chapter exceeds 64 KiB. Shorten it before publishing.',
        assets: 'Attachments',
        assetUpload: 'Upload file',
        assetUploading: 'Uploading...',
        assetHint: 'You can also drag files in or paste them. Max 32 MiB each; images render inline, other types become download links.',
        assetQuota: '{used} used',
        assetInsert: 'Insert',
        assetCopy: 'Copy link',
        assetCopied: 'Link copied',
        assetCopyFailed: 'Copy failed',
        assetDelete: 'Delete',
        assetDeleteTitle: 'Delete attachment',
        assetDeleteMessage: 'Delete "{name}"? References to it in the guide will break and you will need to edit them yourself.',
        assetDeleted: 'Attachment deleted',
        assetDeleteFailed: 'Failed to delete the attachment',
        assetEmpty: 'No files uploaded yet.',
        assetEmptyChapter: 'Select a chapter before uploading.',
        assetNeedChapter: 'Select a chapter first; the reference is inserted into it after upload.',
        assetUploadFailed: 'Failed to upload "{name}"',
        assetLoadFailed: 'Failed to load the attachment list',
        preview: 'Live preview (all chapters)',
        sanitizedPreview: 'Sanitized',
        placeholder: 'Write this chapter here; keep the ## heading on the first line...',
        size: '{size}',
        tooLarge: 'All chapters together exceed 256 KiB. Shorten them before publishing.',
        useBundled: 'Restore bundled guide',
        unsaved: 'Unpublished changes',
        saving: 'Publishing...',
        publish: 'Publish guide',
        historyTitle: 'Version history',
        historyDescription: 'The most recent 20 publishes are retained. Restoring creates a new version without deleting prior records.',
        noHistory: 'No versions have been published. The bundled guide is currently active.',
        revision: 'Version {version}',
        current: 'Current',
        restore: 'Restore version',
        resetTitle: 'Restore bundled guide',
        resetMessage: 'Restore the bundled guide? The current database version remains available in history.',
        restoreTitle: 'Restore old version',
        restoreMessage: 'Republish version {version} as the current guide?',
        loadFailed: 'Failed to load the guide',
        saveFailed: 'Failed to save the guide',
        conflict: 'Another admin changed the guide. The latest version has been reloaded.',
        publishSuccess: 'Guide published. Refresh /guide to view it.',
        resetSuccess: 'Bundled guide restored',
