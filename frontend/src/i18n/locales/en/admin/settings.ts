export default {
    settings: {
      ...
      guideEditor: {
        ...
        description: 'After publishing, every domain uses the same content on /guide. No rebuild or restart is needed. Markdown is supported and unsafe preview content is removed automatically.',
        ...
        size: '{size}',
        tooLarge: 'The guide exceeds 256 KiB. Shorten it before publishing.',
