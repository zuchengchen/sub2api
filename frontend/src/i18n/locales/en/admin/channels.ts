export default {
    ...
    riskControl: {
      ...
      fragmentBlockTTLHint: 'Bounded to 300-900 seconds. Expired blocks are evaluated again.',
      fragmentAllowTTL: 'Allow cache TTL (seconds)',
      fragmentAllowTTLHint: 'Bounded to 1-86400 seconds. Policy changes also invalidate the namespace.',
      ...
      keywordTiersTitle: 'Context-aware keyword tiers',
      keywordTiersHint: 'Only high-confidence patterns block directly. Candidate matches are reviewed by the model, and allowlist entries suppress candidate routing only.',
      hardBlockPatterns: 'High-confidence block patterns',
      hardBlockPatternsPlaceholder: 'One unambiguous pattern per line',
      hardBlockPatternsHint: 'Direct block. Keep this list narrow and reviewable.',
      candidateKeywords: 'Candidate keywords',
      candidateKeywordsPlaceholder: 'One candidate term per line',
      candidateKeywordsHint: 'Routes matching user text to the second-layer model.',
