export default {
    ...
    riskControl: {
      ...
      enforceGateBlocked: 'Layer 2 Enforce requires at least one reachable review channel.',
      ...
      channelTestReachable: 'Channel reachable ({latency} ms)',
      channelTestUnreachable: 'Channel unreachable ({latency} ms)',
