export default {
    ...
    riskControl: {
      ...
      reviewersSummary: 'The online pool fails over DS, Qwen, GLM, then MiMo; a violation needs two online provider votes.',
      onlineReviewersTitle: 'Online review pool (DS / Qwen / GLM / MiMo)',
      onlineReviewersMeta: 'Reasoning disabled and text-only; after one violation, a second provider must agree before blocking (threshold {threshold}).',
      deepseekReviewerMeta: 'V4 Flash · Non-thinking · violation threshold {threshold}',
      yufengReviewerMeta: 'Local YuFeng shadow reviewer; records observations but never supplies an online consensus vote.',
      reviewerEnabled: 'Participating in review decisions',
      reviewerDisabled: 'Not participating in review decisions',
      localShadowEnabled: 'Local shadow enabled; records only and never counts toward two-vote consensus',
      ...
      twoRemoteReviewersRequired: 'Enable at least two distinct online providers so violation consensus can be formed',
