export default {
    ...
    riskControl: {
      ...
      archiveTitle: 'Encrypted Request Archive',
      ...
      archivePreviewFailed: 'Failed to load the encrypted archive preview',
      archiveDownloadFailed: 'Failed to download the encrypted archive',
