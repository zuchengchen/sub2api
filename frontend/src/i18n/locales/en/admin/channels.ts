export default {
    ...
    riskControl: {
      ...
      reviewersSummary: 'The online pool fails over DS, Qwen, GLM, then MiMo; any one usable provider can complete review.',
      onlineReviewersTitle: 'Online review pool (DS / Qwen / GLM / MiMo)',
      onlineReviewersMeta: 'Reasoning disabled and text-only; the first successful provider verdict is used (threshold {threshold}).',
