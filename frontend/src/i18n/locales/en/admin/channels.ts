export default {
    ...
    riskControl: {
      ...
      reviewersSummary: 'The online pool hedges DS, Qwen, GLM, then MiMo; risk verdicts win immediately while safe verdicts preserve provider priority.',
      onlineReviewersTitle: 'Online review pool (DS / Qwen / GLM / MiMo)',
      onlineReviewersMeta: 'Reasoning disabled and text-only; a backup starts after 1.5 seconds for slow reviews (threshold {threshold}).',
      ...
      yufengReviewerMeta: 'Local YuFeng shadow reviewer; records observations but never participates in the online decision.',
      reviewerEnabled: 'Participating in review decisions',
      reviewerDisabled: 'Not participating in review decisions',
      localShadowEnabled: 'Local shadow enabled; records only and never participates in the online decision',
      localShadowDisabled: 'Local shadow disabled',
      ...
      twoRemoteReviewersRequired: 'Enable at least one usable online provider',
