export default {
    ...
    riskControl: {
      ...
      managedProvidersSummary: 'Supported managed OpenAI-compatible providers used for model routing. They do not replace the DeepSeek risk reviewer automatically.',
