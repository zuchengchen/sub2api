export default {
    ...
    riskControl: {
      ...
      textOnly: 'Text only',
      channelHealthSummary: '{healthy}/{enabled} enabled channels healthy',
      ...
      enforceGateReady: 'The Layer 2 Enforce health gate is ready.',
      enforceGateBlocked: 'Layer 2 Enforce is unavailable until every participating reviewer passes a valid health check.',
      ...
      channelHealthChecked: 'Health checked',
      ...
      channelNeedsTest: 'Health check required',
      ...
      channelTestComplete: 'Channel contract test completed',
      channelTestFailed: 'Channel contract test failed',
      channelTestHealthy: 'Health check passed ({passed}/2)',
      channelTestUnhealthy: 'Health check failed ({passed}/2)',
