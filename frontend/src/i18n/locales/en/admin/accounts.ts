export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketDesc: 'Availability by model. Cookie WS maintains 3 Cookie groups per account, each with one verified business WS connection. Only Astra uses WS; other models use HTTP Responses. Each group refreshes after 50 minutes and expires after 60 minutes. The model pauses when no valid Cookie is available.',
