export default {
    accounts: {
      ...
      openai: {
        ...
        outboundCookieWS: 'Cookie WS (default)',
        outboundCookieWSDesc: 'Keep the current Astra Cookie websocket / HTTP fallback. No BPS extra is written.',
        ...
        excelBPSDesc: 'Forward Responses through Excel using this account’s existing ChatGPT OAuth credentials. Exclusive with Cookie WS; disable to restore the default Cookie WS path.',
        ...
        excelBPSModelsHint: 'Matches model names after account mapping. Selected models use Excel / BPS; other models keep Cookie WS / HTTP fallback. An empty selection disables BPS routing.',
        excelBPSNotice: 'Start a new Codex conversation after saving. Selected models use HTTP/SSE regardless of WS mode or ticket injection. Supports Responses, client tools and HTTPS images; base64 images need image relay. max / ultra use xhigh. Model access depends on the upstream.',
        ...
        codexCookieRefreshAt: 'Refresh scheduled: {time}',
        codexCookieCapturedAt: 'Captured: {time}',
        codexCookieExpiresAt: 'Expires: {time}',
        codexCookieGroupCounts: 'Cookie groups verified in this process {ready}/{total} · Unexpired Cookie groups {valid}/{total}',
        codexCookieSlot: 'Group {number}',
        codexCookieSlotVerified: 'Cookie verified',
        codexCookieSlotUnverified: 'Cookie awaiting verification',
        codexCookieSlotSockets: 'Verified WS {count}/{total}',
        codexCookieRefreshDiagnostic: 'Cookie refresh',
        codexCookieWarmupDiagnostic: 'WS recovery',
        codexCookieAttempts: 'Attempts: {count}',
        codexCookieLastAttempt: 'Last attempt: {time}',
        codexCookieLastSuccess: 'Last success: {time}',
        codexCookieLastFailure: 'Last failure: {time}',
        codexCookieNextAttempt: 'Earliest retry: {time}',
        codexCookieRetryHint: 'Retry times are the earliest allowed retry. Actual execution also depends on background check rounds and whether the account can be scheduled.',
        codexCookiePauseReason: 'Paused: {reason}',
        codexCookieRecovery: {
          ready: 'WS {count}/{total} · Ready',
          partial: 'WS {count}/{total} · Partially available',
          recovering: 'WS {count}/{total} · Recovering',
          paused: 'WS {count}/{total} · Paused',
          unavailable: 'WS —/{total} · Status unavailable'
        },
        codexCookiePhase: {
          idle: 'No task in progress',
          no_record: 'No record yet',
          ready: 'Ready',
          waiting: 'Awaiting check',
          restoring: 'Restoring existing Cookie',
          harvesting: 'Acquiring Cookie',
          validating: 'Validating Cookie',
          warming: 'Connecting and verifying WS',
          backoff: 'Awaiting retry',
          paused: 'Paused',
          unavailable: 'Status unavailable'
        },
        codexCookieSkipReason: {
          not_cookie_account: 'Cookie WS does not apply to this account',
          not_active: 'Account is inactive',
          manual_unschedulable: 'Scheduling was disabled manually',
          expired: 'Account has expired',
          rate_limited: 'Account is rate limited',
          overloaded: 'Upstream overload cooldown',
          temporarily_unschedulable: 'Account is temporarily unschedulable',
          model_rate_limited: 'Model is rate limited',
          quota_5h: '5-hour quota exhausted',
          quota_7d: '7-day quota exhausted',
