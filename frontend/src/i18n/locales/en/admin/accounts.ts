export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketDesc: 'Availability by model. Cookie WS maintains 2 Cookie groups per account, each with up to 10 business WS connections. Each group refreshes after 50 minutes and expires after 60 minutes. The model pauses when no valid Cookie is available.',
