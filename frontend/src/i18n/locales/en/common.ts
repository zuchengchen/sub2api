export default {
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    usage: 'Usage',
    buyRedeemCode: 'Buy Redeem Codes',
    redeem: 'Redeem',
  ...
  auth: {
    ...
    apiErrors: {
      ...
      API_KEY_REQUIRED: 'Please provide an API key in the request headers',
      api_key_in_query_deprecated: 'Do not put the API key in the URL query. Use request headers instead.',
      API_KEY_DISABLED: 'API key is disabled',
      API_KEY_INACTIVE: 'API key is not active',
      API_KEY_EXPIRED: 'API key has expired',
      API_KEY_QUOTA_EXHAUSTED: 'API key quota is exhausted',
      API_KEY_RATE_LIMITED: 'Too many failed attempts, please try again later',
      INVALID_AUTH_RATE_LIMITED: 'Too many invalid authentication attempts; retry later',
      API_KEY_AUTH_OVERLOADED: 'API key authentication is temporarily unavailable',
      USER_NOT_FOUND: 'User not found',
      USER_INACTIVE: 'User account is not active',
      ACCESS_DENIED: 'Access denied for this IP',
      ...
      SUBSCRIPTION_MAINTENANCE_FAILED: 'Failed to maintain subscription usage windows',
      USER_RPM_EXCEEDED: 'User requests-per-minute limit exceeded',
      GROUP_RPM_EXCEEDED: 'Group requests-per-minute limit exceeded',
      ...
      REDEEM_CODE_LOCKED: 'Redeem code is being processed, please try again',
      PASSWORD_INCORRECT: 'Current password is incorrect',
      REGISTRATION_DISABLED: 'Registration is currently disabled',
      UNAUTHORIZED: 'Authorization required',
      INVALID_AUTH_HEADER: "Authorization header format must be 'Bearer {token}'",
      EMPTY_TOKEN: 'Token cannot be empty',
      TOKEN_EXPIRED: 'Token has expired',
      INVALID_TOKEN: 'Invalid token',
      TOKEN_REVOKED: 'Token has been revoked (password changed)',
      TOKEN_REFRESH_FAILED: 'Session expired. Please log in again.',
      TOKEN_REFRESH_UNAVAILABLE: 'Unable to refresh the session. Please try again later.',
      AUTH_SESSION_CHANGED: 'Authentication session changed. Please retry.',
    ...
    registrationAccessCodeLabel: 'Invitation or Referral Code',
    registrationAccessCodePlaceholder: 'Enter an invitation or referral code',
    registrationAccessCodeRequired: 'An invitation or referral code is required',
    registrationAccessCodeValid: 'Registration access code is valid',
    registrationAccessCodeInvalid: 'Invalid invitation or referral code',
    registrationAccessCodeValidating: 'Validating registration access code...',
    registrationAccessCodeInvalidCannotRegister: 'Invalid invitation or referral code. Please check and try again',
    registrationGateCodePlaceholder: 'Enter an invitation code, or a referral code when affiliates are enabled',
  ...
  pelicanTest: {
    subtitle: 'From 08:00 to 24:00 Beijing time, every 30 minutes a random animal is chosen, then one GPT-PRO account generates an HTML bicycle SVG animation with gpt-6-astra (reasoning low). Only the last 6 hours of results are kept; click a timestamp to view one. You cannot start a test.',
    empty: 'No results in the last 6 hours. Wait for the next automatic run.',
    time: 'Test time',
    group: 'Group',
    model: 'Model',
    reasoning: 'Reasoning',
