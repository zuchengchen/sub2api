export default {
  ...
  pelicanTest: {
    subtitle: '每 10 分钟从动物名单里随机换一种，再从 GPT-PRO 随机抽一个账号，用 gpt-6-astra（推理深度 low）生成一张骑自行车的 HTML 动画。最近 1 天的结果都会保存，可点上方时间切换查看。不能手动发起测试。',
    empty: '最近 1 天暂无测试结果，请等待下一轮自动测试。',
    time: '测试时间',
    group: '测试分组',
    model: '模型',
    reasoning: '推理深度',
