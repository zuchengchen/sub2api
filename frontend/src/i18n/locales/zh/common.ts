export default {
  ...
  legal: {
    ...
    loginAgreementPrompt: {
      ...
      noticeDescription: '未同意前，邮箱密码输入和快捷登录会保持禁用。',
      viewTerms: '查看条款',
      dialogTitle: '条款更新通知',
      ...
      reject: '拒绝',
      accept: '同意并继续',
      loginRejectedWarning: '未同意最新条款前，无法输入邮箱密码或使用快捷登录。',
  ...
  auth: {
    ...
    continue: '继续',
    rememberMe: '记住我',
    dontHaveAccount: '还没注册？',
    alreadyHaveAccount: '已经注册？',
    ...
    errors: {
      USER_NOT_ACTIVE: '用户已被禁用',
    },
    apiErrors: {
      INSUFFICIENT_BALANCE: '余额不足',
      INVALID_API_KEY: 'API Key 无效',
      API_KEY_REQUIRED: '请在请求头中提供 API Key',
      api_key_in_query_deprecated: '请勿把 API Key 放在 URL 查询参数中，请改用请求头',
      API_KEY_DISABLED: 'API Key 已禁用',
      API_KEY_INACTIVE: 'API Key 未启用',
      API_KEY_EXPIRED: 'API Key 已过期',
      API_KEY_QUOTA_EXHAUSTED: 'API Key 额度已用完',
      API_KEY_RATE_LIMITED: '失败次数过多，请稍后再试',
      INVALID_AUTH_RATE_LIMITED: '认证失败次数过多，请稍后再试',
      API_KEY_AUTH_OVERLOADED: 'API Key 认证暂时不可用',
      USER_NOT_FOUND: '用户不存在',
      USER_INACTIVE: '用户账号未启用',
      ACCESS_DENIED: '当前 IP 无访问权限',
      SUBSCRIPTION_NOT_FOUND: '当前分组没有有效订阅',
      SUBSCRIPTION_INVALID: '订阅无效或已过期',
      SUBSCRIPTION_MAINTENANCE_FAILED: '订阅用量窗口维护失败',
      USER_RPM_EXCEEDED: '用户每分钟请求次数已达上限',
      GROUP_RPM_EXCEEDED: '分组每分钟请求次数已达上限',
      USER_PLATFORM_DAILY_QUOTA_EXHAUSTED: '该平台今日用量额度已用完',
      USER_PLATFORM_WEEKLY_QUOTA_EXHAUSTED: '该平台本周用量额度已用完',
      USER_PLATFORM_MONTHLY_QUOTA_EXHAUSTED: '该平台本月用量额度已用完',
      DAILY_LIMIT_EXCEEDED: '日用量限额已用完',
      WEEKLY_LIMIT_EXCEEDED: '周用量限额已用完',
      MONTHLY_LIMIT_EXCEEDED: '月用量限额已用完',
      ...
      REDEEM_CODE_LOCKED: '兑换码正在处理，请稍后重试',
      PASSWORD_INCORRECT: '当前密码不正确',
      REGISTRATION_DISABLED: '当前未开放注册',
      UNAUTHORIZED: '需要登录',
      INVALID_AUTH_HEADER: 'Authorization 格式必须为 Bearer {token}',
      EMPTY_TOKEN: '令牌不能为空',
      TOKEN_EXPIRED: '登录已过期',
      INVALID_TOKEN: '令牌无效',
      TOKEN_REVOKED: '令牌已失效（密码已更改）',
      TOKEN_REFRESH_FAILED: '会话已过期，请重新登录',
      TOKEN_REFRESH_UNAVAILABLE: '刷新登录状态失败，请稍后重试',
    ...
    registrationAccessCodeLabel: '邀请码或推广码',
    registrationAccessCodePlaceholder: '请输入邀请码或推广码',
    registrationAccessCodeRequired: '请输入邀请码或推广码',
    registrationAccessCodeValid: '注册准入码有效',
    registrationAccessCodeInvalid: '邀请码或推广码无效',
    registrationAccessCodeValidating: '正在验证注册准入码...',
    registrationAccessCodeInvalidCannotRegister: '邀请码或推广码无效，请检查后重试',
    registrationGateCodePlaceholder: '请输入邀请码；邀请返利开启时也可使用推广码',
    affiliateCodeLabel: '推广码',
    affiliateCodePlaceholder: '请输入推广码',
    ...
    linuxdo: {
      ...
      backToLogin: '返回登录',
      invitationRequired: '该 Linux.do 登录尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
    ...
    dingtalk: {
      ...
      callbackMissingToken: '登录信息缺失，请返回重试。',
      backToLogin: '返回登录',
      invitationRequired: '该钉钉登录尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
      invalidPendingToken: '注册凭证已失效，请重新使用钉钉登录。',
      completeRegistration: '完成注册',
      completing: '正在完成注册...',
      completeRegistrationFailed: '注册失败，请检查邀请码后重试。',
      createAccountTitle: '完成钉钉注册',
      registrationDisabledRedirectToBind: '当前已禁止注册新用户，请使用已有用户的邮箱和密码绑定钉钉登录',
      error: {
        title: '钉钉登录失败',
        csrf: '登录会话已过期，请重新扫码登录',
        corp_rejected: '您的钉钉登录不属于本企业，请联系管理员',
    ...
    oidc: {
      ...
      callbackMissingToken: '登录信息缺失，请返回重试。',
      backToLogin: '返回登录',
      invitationRequired: '该 {providerName} 登录尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。',
    ...
    oauthFlow: {
      ...
      profileDetailsDescription: '选择是否将 {providerName} 的昵称或头像应用到当前用户。',
      useDisplayName: '使用昵称',
      useAvatar: '使用头像',
      avatarAlt: '{providerName} 头像',
      reviewProfileBeforeContinue: '请先确认 {providerName} 资料后再继续。',
      chooseHowToContinue: '选择后续操作',
      chooseAccountActionHint: '请选择绑定已有用户，或注册一个新用户。',
      suggestedEmail: '建议邮箱：{email}',
      bindExistingAccount: '绑定已有用户',
      createNewAccount: '注册新用户',
      createAccountHint: '请输入邮箱地址以注册并继续。',
      bindLoginHint: '登录一个已有用户以绑定此次 {providerName} 登录。',
      signInThenBindDescription: '请先登录已有用户，再将此次 {providerName} 登录绑定到该用户。',
      bindSignInToExistingAccount: '将此次 {providerName} 登录绑定到已有用户。',
      bindCurrentAccountTitle: '绑定当前用户',
      bindCurrentAccountDescription: '将此次 {providerName} 登录绑定到当前浏览器已登录的用户。',
      bindCurrentAccount: '绑定当前用户',
      logInAndBind: '登录并绑定',
  ...
  pelicanTest: {
    subtitle: '北京时间每天 8:00–24:00，每 10 分钟从动物名单里随机换一种，再从 GPT-PRO 随机抽一个账号，用 gpt-6-astra（推理深度 low）生成一张骑自行车的 HTML 动画。只保留最近 24 小时的结果，可点左侧时间切换查看。不能手动发起测试。',
    empty: '最近 24 小时暂无测试结果，请等待下一轮自动测试。',
    time: '测试时间',
    group: '测试分组',
    model: '模型',
    reasoning: '推理深度',
