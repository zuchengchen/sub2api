export default {
    ...
    riskControl: {
      ...
      yufengReviewerMeta: '本地 YuFeng 旁路审核；只记录观测结果，不参与线上审核决策。',
      reviewerEnabled: '已参与审核决策',
      reviewerDisabled: '当前不参与审核决策',
      localShadowEnabled: '本地旁路已开启，只记录、不拦截、不参与线上审核决策',
      localShadowDisabled: '本地旁路当前关闭',
      ...
      keywordTiersHint: '所有上下文统一处理：Layer 1 直接拦截；Layer 2 命中后交给 YuFeng；无候选信号直接放行并缓存。',
      ...
      candidateKeywordsHint: '任意上下文命中后进入 YuFeng 复核；未命中不调用模型。',
      candidateSystemReady: '候选系统正常',
      candidateSystemFallback: '候选系统降级',
      candidateSystemHealthHint: 'Layer 2 为空时不会直接放行，所有第二层内容将回退到 YuFeng。',
