export default {
    ...
    riskControl: {
      ...
      refreshStatus: '刷新状态',
      reviewersTitle: '审核器',
      reviewersSummary: 'DeepSeek 负责主审；启用 YuFeng 后仅复核 DeepSeek 的高风险判断。',
      deepseekReviewerMeta: 'V4 Flash · Non-thinking · 违规阈值 {threshold}',
      yufengReviewerMeta: '本地复核器，仅在 DeepSeek 判为高风险后调用',
      ...
      managedProvidersSummary: '这里展示已接入网关的受管 OpenAI 兼容供应商；它们用于模型转发，不会自动替代 DeepSeek 风控审核器。',
