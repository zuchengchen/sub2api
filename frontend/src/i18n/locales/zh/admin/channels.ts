export default {
    ...
    riskControl: {
      ...
      fragmentBlockTTLHint: '限制为 300-900 秒；到期后必须重新审核。',
      fragmentAllowTTL: '放行缓存 TTL（秒）',
      fragmentAllowTTLHint: '限制为 1-86400 秒；策略版本变化也会切换命名空间。',
      ...
      keywordTiersTitle: '上下文感知关键词分层',
      keywordTiersHint: '仅高置信规则直接拦截；候选词交给模型复核；白名单只抑制候选路由。',
      hardBlockPatterns: '高置信拦截规则',
      hardBlockPatternsPlaceholder: '每行一个无歧义规则',
      hardBlockPatternsHint: '直接拦截，请保持列表精简且可审查。',
      candidateKeywords: '候选关键词',
      candidateKeywordsPlaceholder: '每行一个候选词',
      candidateKeywordsHint: '用户文本命中后进入第二层模型复核。',
