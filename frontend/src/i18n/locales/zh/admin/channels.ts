export default {
    ...
    riskControl: {
      ...
      enforceGateBlocked: '当前实例尚无已确认可连通渠道；保存 Enforce 时服务端会即时 Ping。',
      ...
      channelTestComplete: '渠道连通性检查完成',
      channelTestFailed: '渠道连通性检查失败',
      channelTestReachable: 'HTTP 可达（{latency} ms，状态 {status}）；未验证密钥、模型或审核结果',
      channelTestUnreachable: 'HTTP 无法连通（{latency} ms，状态 {status}）',
      policyTitle: '审核策略',
