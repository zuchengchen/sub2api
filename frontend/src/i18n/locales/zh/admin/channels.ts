export default {
    ...
    riskControl: {
      ...
      textOnly: '仅文本',
      channelHealthSummary: '{healthy}/{enabled} 个启用渠道健康',
      ...
      enforceGateReady: 'Layer 2 Enforce 健康门禁已通过。',
      enforceGateBlocked: 'Layer 2 Enforce 暂不可用：需要参与决策的审核器通过有效健康检查。',
      ...
      channelTestComplete: '渠道合约测试完成',
      channelTestFailed: '渠道合约测试失败',
      channelTestHealthy: '健康检查通过（{passed}/2）',
      channelTestUnhealthy: '健康检查未通过（{passed}/2）',
      policyTitle: '审核策略',
