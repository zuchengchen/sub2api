export default {
    ...
    riskControl: {
      ...
      refreshStatus: '刷新状态',
      reviewersTitle: '审核器',
      reviewersSummary: '线上审核池按 DS、Qwen、GLM、MiMo 顺序故障转移；违规必须由两家线上供应商共同确认。',
      onlineReviewersTitle: '线上审核池（DS / Qwen / GLM / MiMo）',
      onlineReviewersMeta: '无推理、纯文本审核；首个违规后必须再取得第二家供应商的违规票才会拦截（阈值 {threshold}）。',
      deepseekReviewerMeta: 'V4 Flash · Non-thinking · 违规阈值 {threshold}',
      yufengReviewerMeta: '本地 YuFeng 旁路审核；只记录观测结果，不参与线上两票拦截。',
      reviewerEnabled: '已参与审核决策',
      reviewerDisabled: '当前不参与审核决策',
      localShadowEnabled: '本地旁路已开启，只记录、不拦截、不计入双票',
      ...
      twoRemoteReviewersRequired: '线上审核池至少需要启用两个不同供应商，违规双票才有意义',
