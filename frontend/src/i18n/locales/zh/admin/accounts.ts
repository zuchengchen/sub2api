export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketDesc: '显示各模型的可用状态。Cookie WS 模式每账号保持 3 组 Cookie，每组最多 1 条已验证业务 WS，仅 Astra 走 WS、其他模型走 HTTP Responses；各组在获取后第 50 分钟刷新、第 60 分钟过期。没有有效 Cookie 时暂停该模型调度。',
