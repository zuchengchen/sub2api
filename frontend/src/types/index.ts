...
export type GroupPlatform = 'anthropic' | 'openai' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax'
