...
export interface User {
  ...
  is_vip?: boolean // Super VIP flag (auto-granted when total balance crosses the threshold; permanent)
...
export type GroupPlatform = 'anthropic' | 'openai' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go'
